...
n");
              set("replace_file", "/d/wizz/calvin/longzhu/zhu2");
...
被山石砸得皮破血流，还被风迷了双眼，又被水浇个透心凉，肌肤尽裂。\n" NOR;
                                ...
                                target->receive_damage("sen", damage*8/1);
                                target->receive_wound("sen", damage*8/1);
                                target->receive_damage("kee", damage*8/1);
