...
{
       seteuid(getuid());
       set_name(HIW"特权圣衣"NOR,({"wiz cloth","cloth","pifeng","armor" }));
       set("long",@LONG
※※※※※※※※※※※※※※※※※※※※※※※※※※※※
※  命  令  ※    用       法   ※    说        明    ※
※※※※※※※※※※※※※※※※※※※※※※※※※※※※
...
int fengplayer (string str)
{
  ...
  tell_object(ob,"忽然有人在里耳边说道:天下大乱啦...\n");
...
int jiefengplayer (string str)
{
  ...
  ob->enable_player(); 
  tell_object(ob,"忽然有人在你耳边说道:天下太平了...\n");
  return 1;
}
//  XING 使人苏醒
int xing (string str)
...
int bx(string arg)
{
  ...
  if (arg) {
    ...
    message("shout", HIM "【三界神鬼】无天老魔:我要消灭所有三界中的生灵,独霸天下!★顺我者昌★逆我者亡★\n" NOR,users());
    bxid->save();
    return 1;
  }
}
...
int yao (string arg)
{
 ...
 message_vision( sprintf(HIY "突然间天空一道闪电,$N刚好被击中,但是好象一点事也没有。\n" NOR,
