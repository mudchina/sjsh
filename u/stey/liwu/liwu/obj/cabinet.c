...
{ 
    ...
    if ((int)me->query("combat_exp") <3000 || (int)me->query("mud_age")<36000)
...
if( skl==0 )return notify_fail("你好意思去拿？再练一会吧！\n");
     ...
     ob = new("/u/sunny/happy/obj/happybox");
     ob->move(me);
