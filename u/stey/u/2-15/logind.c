...
void logon(object ob)
{
    ...
    write("         Welcome to "BLINK HIY"XLQY!"NOR" Select GB or BIG5 (gb/big5):");
...
// try strict ban here...weiqi.
	...
	printf("ÏÉÂÂÇéÔµ("HIM"ÖªÇïÕ¾"NOR")ÏÖÓĞ×¢²áÍæ¼Ò"HIR"%s"NOR"Î»¡£\n",chinese_number(howmany_user()));
	printf("ÏÉÂÂÇéÔµ("HIM"ÖªÇïÕ¾"NOR")¿ªÕ¾ÒÔÀ´£¬×î¸ßÔÚÏßÊıÄ¿£º"HIY"%s"NOR" ÈË£¬Æ½¾ùÔÚÏßÊıÄ¿£º"HIY"%s"NOR" ÈË¡£\n",chinese_number(max_online),chinese_number(avg_online));
...
ÇëÄú¸ø×Ô¼ºÏëÒ»¸ö·ûºÏ¡¼ÏÉÂÂÇéÔµ¡½Éñ»°ÊÀ½çµÄÖĞÎÄÃû×Ö¡£Õâ
¸öÃû×Ö½«´ú±íÄãÔÚÏÉÂÂÇéÔµÖĞµÄÈËÎï£¬¶øÇÒÍùºó½«²»ÄÜÔÙ¸ü¸Ä¡£
	...
	"/adm/daemons/toptend"->topten_checkplayer(user);
		...
		tell_room(startroom, user->query("name") + "Á¬Ïß½øÈëÕâ¸öÊÀ½ç¡£\n",
   		...
   		if(file_size("/log/notice")>0){
			write(CYN"     ¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô"HIR"ÏÉÂÂÇéÔµÁ¬ÏßÍ¨Öª"NOR CYN"¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô\n");
