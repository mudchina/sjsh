...
varargs int do_attack(object me, object victim, object weapon, int attack_type)
{
	...
	&& random(8)==0 && victim->query("combat_exp") > random(me->query("combat_exp"))) {
	   message_vision(CYN + "$n闪过$N之攻势，仰天长啸，身形展动，使出了[云程九万里]的心法！！\n"+NOR, me, victim);
	  ...
	  && random(8)==0 && victim->query("combat_exp") > random(me->query("combat_exp") )) {
	   message_vision(CYN + "$n深吸一口气，全身真气流转，方寸不传之密[菩提树]信手使出！！\n"+NOR, me, victim);
           do_attack(victim, me, weapon, TYPE_REGULAR);
           do_attack(victim, me, weapon, TYPE_REGULAR);
           victim->set("sp/putishu_use", time());
            ...
            && random(10)==0 && victim->query("combat_exp") > random(me->query("combat_exp"))) {
             message_vision(CYN + "$n一声怒吼箭步上前，使出了[修罗霸王靠华山]！！！\n"+NOR, me, victim);
             message_vision(CYN + "修~~~罗！\n"+NOR, me, victim);
             do_attack(victim, me, weapon, TYPE_REGULAR);
             message_vision(CYN + "      霸~~~王！！\n"+NOR, me, victim);
             do_attack(victim, me, weapon, TYPE_REGULAR);
             message_vision(CYN + "       	靠华山！！！\n"+NOR, me, victim);
             do_attack(victim, me, weapon, TYPE_REGULAR);
            ...
            if( damage_bonus > 0 ) {
               ...
               && random(8)==0 && victim->query("combat_exp") > random(me->query("combat_exp")) ){
               message_vision(CYN + "$n运起月宫密传之[兰心慧剑断情丝]心法，借$N之力恢复了行动！！！\n"+NOR, me, victim);
	    ...
	    message_vision(CYN + "$n使出[魑魅魍魉]身法，犹如鬼魅，将$N的劲力卸开部分！！！\n"+NOR, me, victim);		
	    ...
	    if (victim->query("sp/xinghuoliaoyuan") && victim->query_skill("force") > 200
            ...
            message_vision(CYN + "正在危急之际，忽然间$n只觉一股热流自脚底涌泉穴升起，好一个[星火燎原]神功！！！\n"+NOR, me, victim);	
            ...
            message_vision(CYN + "$n深吸一口气，在最后关头硬是将要害避过,[万流归宗]确是非同凡响！！\n"+NOR, me, victim);
            wanliu = 0;
