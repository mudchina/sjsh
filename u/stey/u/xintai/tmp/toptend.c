...
#define TOPTEN_SPELLS	"/topten/spells.txt"
#define TOPTEN_PER      "/topten/per.txt"
#define TOPTEN_AGE      "/topten/age.txt"
#define TOPTEN_TASK     "/topten/task.txt"
#define RICH_B          CYN"仙侣情缘十大"HIC"富豪(RICH）"NOR
#define QUESTS_B        CYN"仙侣情缘十大"HIC"解迷高手（QUESTS）"NOR
#define PKER_B          CYN"仙侣情缘十大"HIC"P K 狂魔（PKER）"NOR
#define NKER_B          CYN"仙侣情缘十大"HIC"N K 高手（NKER）"NOR
#define EXP_B           CYN"仙侣情缘十大"HIC"武学高手（EXP）"NOR
#define DX_B            CYN"仙侣情缘十大"HIC"道行高手（DX）"NOR
#define FORCE_B         CYN"仙侣情缘十大"HIC"内力高手（FORCE）"NOR
#define SPELLS_B    CYN"仙侣情缘十大"HIC"法力高手（SPELLS）"NOR
#define PER_B           CYN"仙侣情缘十大"HIC"美女（PER）"NOR
#define AGE_B           CYN"仙侣情缘十大"HIC"老前辈（AGE）"NOR
#define TASK_B          CYN"仙侣情缘十大"HIC"TASK高手（TASK）"NOR
