...
([
	"action" : 
"$N一招"+MAG"「小园艺菊」"NOR"，手中$w迅疾向$n的下盘连点三点",
		"dodge"  : -15,
	"damage" : 20,
		"parry"  : -5,
	"force"         : 50,
...
([
	"action" :
"$N使出"+BLINK""+MAG"「西窗夜话」"NOR"，手中$w中宫直入，攻向$n的$l",
		"dodge"  : -5,
	"damage" : 20,
		"parry"  : -10,
	"force"         : 50,
...
([
	"action" : 
"$N手中$w由下而上卷起，犹如打起竹帘一般，却是"+BLINK""+MAG"「竹帘临池」"NOR"",
		"dodge"  : -5,
	"damage" : 20,
		"parry"  : -10,
	"force"         : 80,
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
        ...
        if( random(damage_bonus/2) > victim->query_str() ) {
                ...
                switch(random(3)) {
                        case 0: return "$n身上被剑气划开一道深可见骨的伤口！\n";
                        case 1: return "$N劲力一吐，一道剑气从$w中冲出击中$n的$l！\n";
                        case 2: return "$N低喝一声，$w上剑芒吞吐闪烁！\n";
                }
        }
}
