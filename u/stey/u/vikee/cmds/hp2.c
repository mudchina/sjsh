...
int main(object me, string arg)
{
        ...
        printf(NOR CYN"┏━━━━━━━━━━━━━━"HIR"仙·侣·情·缘"NOR CYN"━━━━━━━━━━━━━━┓\n"NOR,);
        printf(NOR CYN"┃"NOR WHT" 个人简表："NOR CYN" 姓 名："NOR WHT"%-10s "NOR CYN" 性别："NOR WHT"%-10s "NOR CYN"I D："NOR WHT"%-13s"NOR CYN"┃\n"NOR,ob->name(),ob->query("gender"),"["+capitalize(ob->query("id"))+"]");
        printf(NOR CYN"┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┦\n"NOR);
        ...
        printf(NOR WHT"  【 武学 】   %s%11-d "NOR CYN"       ┃\n"NOR,HIG,(int)ob->query("combat_exp"));
	...
	printf(NOR WHT"  【 道行 】   %s%11-d "NOR CYN"       ┃\n"NOR,HIY,"你现在没有道行！");
	else
