...
#ifdef GB_AND_BIG5
    cat(BANNER);
    write("                                                                         Î÷ÓÎ¼Ç»¶Ó­ÄúÀ´·Ã£¡Ê¹ÓÃ¹ú±êÂëµÄÍæ¼ÒÇë¼üÈë£º[1;38mgb[0;37;0m\n");
    write("               ÏÉÂÂÆæÔµ»¶Ó­ÄúÀ´·Ã£¡Ê¹ÓÃBIG5µÄÍæ¼ÒÇë¼üÈë:¡G[1;33mbig5[0;37;0m\n\n");
	...
	ob->save();
		...
		destruct(mbx);
	        ...
	        CHANNEL_D->do_channel( this_object(), "sys",
                sprintf(NOR WHT "%sÓÉ " HIG "%s" NOR WHT "Á¬Ïß½øÈë,
		IPÀ´×Ô£º"HIG"%s"NOR,
