...
void init()
{
	...
	this_player()->receive_damage("sen", 30);
    this_player()->receive_wound("sen",  30);
...
{
        int total_steps;
//        total_steps = ( 100 - (int)this_player()->query_skill("spells",1) ) / 10 ;
//        if ( total_steps <= 0 ) total_steps = 1 ;  
        if( me->query("family/family_name") == "盘丝洞") total_steps = 1 ; 
           else total_steps = 10;
	if ( dir == "north")
