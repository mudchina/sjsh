...
int rank_me()
{
	...
	exp=(int)me->query("combat_exp");
          if( me->query("title") == "斩妖除魔掌门仙侠" ||
          me->query("title") == "天高云傲蜀山掌门女侠" )
	...
	{
                if( exp <= 20000 ){
              me->set("title", "蜀山剑派女杂役" );
		} else if(exp <= 50000 ){
              me->set("title", "蜀山剑派入门女弟子");
		} else if(exp < 100000 ){
              me->set("title", "蜀山剑派女侠");
		} else if(exp <= 200000 ){
              me->set("title", "蜀山剑派出山侠女");
		} else if(exp <= 500000 ){
              me->set("title", "蜀山剑派剑圣亲随侠女");
		} else if(exp <= 1000000 ){
              me->set("title", "蜀山剑派绝世女剑客");
		} else if(exp <= 2000000 ){
              me->set("title", "蜀山剑派朝圣右长老");
		} else {
              me->set("title", "蜀山剑派剑圣传人");
		}
               ...
               (string)me->query("gender") == "男性" ) 
{
                ...
                me->set("title", "蜀山剑派入门弟子");
          } else if(exp < 100000 ){
                me->set("title", "蜀山剑派少侠");
          } else if(exp <= 200000 ){
                me->set("title", "蜀山剑派护门侠客");
          } else if(exp <= 500000 ){
                me->set("title", "蜀山剑派剑圣亲随侠客");
          } else if(exp <= 1000000 ){
                me->set("title", "蜀山剑派隐世剑侠");
          } else if(exp <= 2000000 ){
                me->set("title", "蜀山剑派传功左长老");
          } else {
                me->set("title", "蜀山剑派剑圣传人");
          }
          tell_object(me, 
HIR""+ob->query("name")+"对你说：你可以做"+me->query("title")+"。\n"NOR);
          tell_room(environment(me),
HIR""+ob->query("name")+"对"+me->query("name")+"说：你可以做"+me->query("title")+"
。\n"NOR, ({me, me}));
                 return 0;
