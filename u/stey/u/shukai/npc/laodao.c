...
int do_put(string arg)
{
  ...
  if (ob->query("title") == "先遣部队")
      return notify_fail(CYN"这样炼妖，小心被关死牢。\n"NOR);
...
//    if (userp(neidan)) base_reward *= 2;     // 若卖玩家，奖励加倍。不提倡pk，取消。
