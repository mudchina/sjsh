...
int do_jibai(string arg)
{
        ...
        tell_object(me,HIW"因为你的诚心和积德，祖师爷奖励你"+ chinese_daoxing((int)me->query("shushan/reward",1) * 3)+"道行和"
        +chinese_number((int)me->query("shushan/reward",1))+"点潜能！\n你顿时觉得修行充实了许多！\n"NOR);
        ...
        else tell_object(me,HIY"只要你多行善积德，祖师爷一定会奖励你。\n"NOR);
        return 1;
}                
