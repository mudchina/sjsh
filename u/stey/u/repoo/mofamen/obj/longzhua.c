...
void create()
{
 set_name(HIB"黑龙"+HIR"之爪"NOR, ({ "long zhua", "zhua", "dagger" }) );
  init_dagger(25);
  set("unit", "根");
  set_weight(300);
  if( clonep() )
  ...
  set("wield_msg","$N拿起$n握在手里，感觉到黑龙的心跳。\n");
  setup();
}
int init()
{
...
void longzhua(object who,object ob)
{
 ...
 message_vision(HIR"\n$N"+HIY"身上已经没有东西啦！\n"NOR,target);
                ...
                thing->move(who);
message_vision(HIB"\n黑龙"+HIR"之爪"+HIW"飞了出去，从"+HIR"$N"+HIW"身上搜到"+thing->query("unit")+HIY+" " +thing->query("name")+HIW" "+"！\n"NOR,target);
        }
