...
void init()
{
	object me = this_object();
         ...
         me->create_identity("/d/tianpeng/npc/zhubajie", "/d/tianpeng/sandong");
...
int rank_me()
{
	...
	{
                if( exp <= 20000 ){
			me->set("title", "五庄观护观仙童");
		} else if(exp <= 50000 ){
			me->set("title", "五庄观守园力士");
		} else if(exp < 100000 ){
			me->set("title", "五庄观伏魔力士");
		} else if(exp <= 200000 ){
			me->set("title", "五庄观松月真人");
		} else if(exp <= 500000 ){
			me->set("title", "五庄观驾鹤使者");
		} else if(exp <= 1000000 ){
			me->set("title", "五庄观南山不老仙");
		} else if(exp <= 2000000 ){
			me->set("title", "五庄观八卦真仙");
		} else {
			me->set("title", "五庄观真武道尊");
		}
