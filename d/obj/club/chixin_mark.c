...
#include <ansi.h>
#include <weapon.h>
#define CLUB_NAME "痴心女儿帮"
#define CLUB_ID "chixin"
#define CLUB_CHANNEL "chixin"
#define CLUB_MARK "chixin necklace"
inherit SWORD;
...
void create()
{
        set_name(HIM"女儿帮情信"NOR,({"chixin necklace","necklace","club_mark","sword","jian"}));
	set_weight(0);
...
这是一个五彩玉佩令牌，隐隐幻出字型，此乃女儿帮之信物。
你可以用(help chixin)来查看有什么痴心女儿帮指令。若想了解痴心女儿帮
的历史可以用(about chixin)来取得进一步的资料。
...
string show_level(object user)
{
 ...
 mapping info;
 string str;
 if(wizardp(user)) return "【荣誉会员】痴心女儿帮荣誉帮众  ";
 ...
 switch(rank)
 {
 	case 10: str+="痴心女儿帮主      "; break;
 	case 9: str+="痴心女儿帮主相公  "; break;
 	case 8: str+="痴心女儿帮主    "; break;
 	case 7: str+="痴心女儿帮主护卫  "; break;
 	case 6: str+="痴心女儿帮资深长老  "; break;
 	case 5: str+=info["info1"]+"分堂主    "; break;
 	case 4: str+=info["info1"]+"副堂主    "; break;
 	case 3: str+="痴心女儿帮护法      "; break;
 	case 2: str+="痴心女儿帮宫女      "; break;
