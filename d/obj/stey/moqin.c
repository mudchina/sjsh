...
string ori_long="一把碧玉的魔琴，琴身几乎透明，闪着点点寒光，
琴身似乎有个机关能装 (install) 些暗器进去。\n";


void create()
{
       set_name( HIC"宝宝魔琴" NOR, ({"baobao moqin","qin","sword"}));
	set_weight(4000);
        if( clonep() )
                ...
                set("value", 100000);
                set("material", "steel");
                set("wield_msg", "$N冷笑一声，从背后拔出了宝宝魔琴。\n");
                set("unwield_msg", "$N将手中的宝宝魔琴插回鞘中，嘴角多了一丝笑意。\n");
