...
#define DIRNAME "/d/xuyi/npc/"

#define MYFILE "/d/xuyi/npc/zhangmen.c"

void create()
{
   set_name("大弟子", ({ "shen jiang", "shenjiang","jiang","zhangmen","zhang men" }) );
   set("loc_name",  HIG"伏魔神将"NOR);
   set("gender", "男性" );
   set("age", 30);
   set("str", 30);
   set("per", 30);
...
void init()
{
   ...
   me->create_identity("/d/xuyi/npc/prince", "/d/xuyi/piandian");
...
void reset_me (object me)
{
   ...
   me->set_name("大弟子", ({ "shen jiang", "shenjiang","zhang men","zhangmen" }) );
   me->set("gender", "男性" );
...
string zm_apply()
{
   ...
   return "盱眙弟子当以降妖除魔为任，不强是不行的。如有意出掌此位，还请一战。\n";
}
