...
int do_climb(string arg)
{
  ...
  if (!((string)me->query("family/family_name")=="平民")
    ...
    {
      message_vision("六重天神拦道：此间并非戏耍之处，请立即离开!\n", me);
    }
  else
    {
      if ((int)me->query_skill("dodge", 1)<130 && (int)me->query_skill("moondance", 1) < 100)
        {
