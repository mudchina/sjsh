...
void create()
{
        set_name("Ğû´«¾«Áé", ({"xuancuan jingling","jinglin"}));
	set("gender", "ÄĞĞÔ" );
	set("age", 23);
...
varargs void drool(string msg, string who)
{
	...
	||	(strsrch(msg, "Drooler") >= 0)) {
		...
		switch(random(10)) {
                case 0: command("es ÏÉÂÂÇéÔµÖ®±¦¼¦Õ¾ 61.150.127.254 6666 »¶Ó­¸÷Î»£¡");      break;
                case 1: command("xyj ÏÉÂÂÇéÔµÖ®±¦¼¦Õ¾Ö÷Ò³ http://newxlqy.yeah.net »¶Ó­¸÷Î»£¡");     break;
                case 2: command("xyj ÏÉÂÂÇéÔµÖ®±¦¼¦Õ¾Ö÷Ò³ http://newxlqy.yeah.net»¶Ó­¸÷Î»£¡");     break;
                case 3: command("es ÏÉÂÂÇéÔµÖ®±¦¼¦Õ¾ 61.150.127.254 6666 »¶Ó­¸÷Î»£¡");      break;
		...
		case 1:	command("say ÕæµÄ£¿" + msg + "£¿");	break;
                case 2: command("es ÏÉÂÂÇéÔµÖ®±¦¼¦Õ¾ 61.150.127.254 6666 »¶Ó­¸÷Î»£¡");      break;
