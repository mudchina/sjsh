...
void init()
{
        object me = this_object();
            ...
            me->create_identity("/d/swordman/npc/xun", "/d/swordman/dating");
...
void reset_me (object me)
{
        ...
        for(i=0; i<sizeof(inv); i++)
        {
         ...
         me->set_name("大弟子", ({ "meng zhu", "mengzhu" }) );
        me->set("gender", "男性" );
        me->set("title","飞天御剑盟主");
...
int convert_identity (object me, object ob)
{
        ...
        if (ob->query("gender")=="男性") {
        	me->set_name(ob->query("name"), ({ "meng zhu", "mengzhu" }) );
	       	me->set("title","飞天御剑盟主");
        } else{
        	me->set_name(ob->query("name"), ({ "meng zhu", "mengzhu" }) );
	       	me->set("title","飞天御剑盟主");
...
"你曾叛师欺祖，言无信行不轨，岂能出任掌门弟子一职！\n";
        ...
        if( (string)ob->query("gender") == "男性" )
                return
"好！师兄有意出任飞天御剑盟主一职？我们就切磋一下吧！\n";
        else return "好！师姊有意出任飞天御剑盟主一职？我们就切磋一下吧！\n";
}
