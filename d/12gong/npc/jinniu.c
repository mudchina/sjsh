   ...
   if(! present(me,environment()) )
     ...
     {        
       ...
       if(random(3)==0)
        ...
        message_vision(YEL"$N念念有词，一只猎狗向$n冲来！\n",ob,me);

                if(random(3)==0)

                {
              message_vision(YEL"$N被猎狗的尖牙咬了个大窟窿！\n"NOR,me);
        ...
        message_vision(HIR"$N看准方向，躲开了$n的撕咬！\n"NOR,me,ob);
        }
        break;
...
void die()
{
        ...
        {
        ob->start_busy(3);
message("chat",HIY+"【黄金十二宫】雅典娜(Yadian na):"+ob->name()+"闯过了第二宫金牛宫，继续向黄金战士前进!\n"NOR,users()); 
