...
void create()
{
       set_name("李英奇", ({"li yingqi", "li", "yingqi","master"}));
       set("long","峨嵋山第三代弟子中最杰出的人物之一, 天玑剑的传人。\n");
       set("title", HIM"峨嵋派天玑剑传人"NOR);
       set("gender", "女性");
       set("age", 24);
       set("class", "xian");
...
setup();
          ...
          carry_object("/d/emei/obj/tianji")->wield();
...
void attempt_apprentice(object ob)
{
	 ...
	 {
		command ("say 你是阳刚之躯无法学习天玑剑，还是去找长空无机学习雷炎剑吧。");
		return;
        }
