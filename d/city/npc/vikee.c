...
void create()
{
        ...
        set("long", "他是发送装备的三界天后☆小宁宁☆你可以(list)查看想要的东西。\n");
        set("gender", "女性");
	set("age", 20);
	set("per", 40);
        set("title",""HIG"☆三界天后☆");
	...
	set("chat_chance",20);
//    set("chat_msg", ({
  //        "☆小宁宁☆轻声告诉你：你可以用list指令列出想要的东西！\n",
//        "☆小宁宁☆轻声告诉你：你可以用yao指令向魔术师我索取装备。\n",
//        "☆小宁宁☆轻声告诉你：你可以用yao指令向魔术师我索取装备。\n",
//        }));
	setup();
...
int do_fight(string arg)
{
  ...
  {
        message_vision("$N看样子想打架，但☆小宁宁☆很有涵养,不和$N动粗。\n",who,me);
     return 1;
  }
  return 0;
}
...
int do_kill(string arg)
{
  ...
  if (arg && present(arg,environment(who))==me)
  {
message_vision("$N看样子想杀死☆小宁宁☆，但☆小宁宁☆是文化人,没跟$N一般见识。\n",who,me);
...
int do_cast(string arg)
{
  ...
  object me = this_object();
    ...
    message_vision("$N对着☆小宁宁☆结结巴巴的念了几句咒语，自己都感觉难听死了。\n",who,me);
...
int do_throw(string arg)
{
  ...
  message_vision("$N掏出暗器，看了看☆小宁宁☆，信心不足，又把暗器收了起来。\n",who,me);
		...
		sscanf(arg,"%s",type);
			...
			case "armor":
				...
				ob->set("no_sell", 1);
        			...
        			ob->set("no_give", 1);
				ob->move(who);
                                tell_object(who,"☆小宁宁☆把"+ob->query("name")+"交给你,并告诉你:带好，别乱丢哦！\n");
				break;
			case "pifeng":
