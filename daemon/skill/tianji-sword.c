...
([	  "name":   "天河倒泻",
	"action" : "$N长剑圈转，一招"+BLINK""+HIY"「天河倒泻」"NOR"，手中$w平展下刺，一剑轻轻划
过$n的$l",
	"force" : 120,
	"dodge" : 20,
	"damage" : 280,
...
([	  "name":   "「天崩地裂」",
	"action" : "$N剑芒吞吐，幻若灵蛇，右手$w使出一式"+BLINK""+HIC"「天崩地裂」"NOR"，剑势曼妙，
刺向$n的$l",
	"force" : 130,
	"dodge" : 25,
	"damage" : 300,
...
"+BLINK""+HIW"「天外摘星」"NOR"跃跃洒洒飘向$n的$l",
	"force" : 120,
	"dodge" : 25,
	"damage" : 320,
	"lvl" : 0,
...
([	  "name":   "破云见日",
	"action" : "$N退步，左手剑指划转，腰部一扭，右手$w一记"+BLINK""+HIG"「破云见日」"NOR"自下
而上刺向$n的$l",
	"force" : 150,
	"dodge" : 35,
	"damage" : 400,
...
int practice_skill(object me)
{
	...
	||	(int)me->query("force") < 3 )
		return notify_fail("你的内力或气不够，没有办法练习天玑剑。\n");
