...
int cast(object me, object target)
{
        ...
        HIB "$N口中喃喃地念著咒文，手中一团紫光渐渐扩大，灵动无比！\n只听$N大喝一声“天魔浊魂！”，紫光化为一道光剑，一闪间疾刺向$n！\n" NOR,
        //initial message
        HIR "结果「嗤」地一声，紫光从$n身上透体而过，拖出长长的七彩光气。光气绕了回来，散入$N的体内！\n" NOR,
        //success message
        HIB "$n摈除心魔，结果「嗤」地一声，紫光从$n身上透体而过，无声无息地钻入地下！\n" NOR,
        //fail message
        HIB "但是$n道心坚定，法力高强。紫光一顿，「嗤」地一声折向$N！\n" NOR,
