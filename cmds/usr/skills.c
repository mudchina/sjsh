...
printf(NOR HIW"┏━━━━━━━━━━━━━"HIR"三  界  神  话" HIW"━━━━━━━━━━━━━┓\n"NOR,);
        printf(NOR HIW"┃"NOR YEL" 所学技能"NOR YEL" 姓 名："NOR WHT"%-12s "NOR YEL" 性别："NOR WHT"%-10s "NOR YEL"I D："NOR WHT"%-13s"NOR HIW"┃\n"NOR,ob->name(),ob->query("gender"),"["+capitalize(ob->query("id"))+"]");
        printf(NOR HIW"┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫\n"NOR);
...
printf(NOR HIW"┃"NOR"%s%s%-40s" NOR "   - %-10s %4d/%5d"HIW"┃"NOR"\n", 
 ...
 printf(NOR HIW"┗━━━━━━━━━━━━━━━━━━  "HIG"SJSH--QZSD"HIW"  ━━━━━━━━┛\n"NOR);
                        write("\n");
return 1;
}
