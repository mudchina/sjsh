...
void do_say(object knower)
{
        ...
        message_vision("$N嘟囔道：“我跟你都说了，要这些东西没好"
                       "事，这不？出事了吧？”\n", knower);
}
...
int npc_accept_object(object me, object who, object ob)
{
        ...
        {
                message_vision("$N一脸茫然的望着$n。\n", me, who);
                return -1;
        }

        message_vision("$N大喜，接过" + ob->name() + "看了看，对$n道：“这位" +
                       RANK_D->query_respect(who) +
                       "，很好，很好！”\n", me, who);
        COUNT--;

        message_vision("$N交给$n一些钱作为报酬。\n", me, who);
...
private void do_notice(object me, object who)
{
        ...
        message_vision("$N点了点货，又对$n道：“我还需要" +
