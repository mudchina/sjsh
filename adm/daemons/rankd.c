...
string *exp_level_desc = ({
	...
	HIW "深不可测" NOR,
        WHT "纵横天界" NOR,
         HIR "无敌"HIY"天宫" NOR,
        HIC "笑傲"HIW"西游" NOR,
          BLINK HIR "众"HIY"佛"HIC"之"HIW"尊" NOR
});
...
string _query_rank(object ob)
{
	...
	case "女性":
		switch(wizhood(ob)) {
                        case "(admin)": return HIW "【 三界帝后 】" NOR;
                        case "(arch)":          return HIR "【 三界天后 】" NOR;
                        case "(wizard)":        return HIC "【 三界巫女 】" NOR;
                        case "(apprentice)":    return HIW "【见习巫女】" NOR;
                                case "(immortal)":      return HIW "【客座巫女】" NOR;
                                case "(elder)":         return HIG "【荣誉玩家】" NOR;
			default:
				switch(ob->query("class")) 
				{
//------------------rank for girls--------------------
case "tianpeng":
if ( ob->query("family/family_name") == "天蓬元帅府" )
        if(dx<1000) 
                return HIR "【 女家兵 】" NOR;
        else if(dx<10000) 
                 return HIR "【 女家将 】" NOR;
                ...
                return HIR "【"+at+"元帅右护法】" NOR;
        else 
                return HIR "【"+at+"元帅右亲信】" NOR;
                break; 
case "kunlun":
             if(dx<1000)  
                    return RED "【 小仙女 】" NOR; 
             ...
             if(dx<100000)  
                    return RED "【 灵  姑 】" NOR; 
             if(dx<500000)  
                    return RED "【"+at+"灵姑】" NOR; 
             if(dx<700000)
                    return RED "【"+at+"圣灵姑】" NOR; 
            else  
                return HIW "【"+at+"圣灵母】" NOR;
            break; 
case "youxia":
                if(dx<1000)  
                        return HIM "【 女  侠 】" NOR; 
                        ...
                        return HIM "【 "+at+"侠女 】" NOR; 
                else if(dx<1000000)  
                        return HIM "【 "+at+"大侠 】" NOR; 
                else  
                        return HIM "【 "+at+"圣侠 】" NOR; 
                break; 
case "wusheng":		           
	if(dx<1000) 
		return GRN "【 玉罗刹 】" NOR;
	...
	break;
case "sanjie":
if ( ob->query("family/family_name") == "三界山" )
	if(dx<1000) 
		return HIR "【 小魔女 】" NOR;
	else if(dx<10000) 
		return HIR "【 妖　精 】" NOR;
		...
		return HIR "【"+at+"女魔王】" NOR;
	else 
		return HIR "【"+at+"大女魔王】" NOR;
	break;		

/*
if ( ob->query("family/family_name") == "天一宫" )
	if(dx<1000) 
		return HIR "【 道　姑 】" NOR;
	else if(dx<10000) 
		return HIR "【 仙　姑 】" NOR;
		...
		return HIR "【"+at+"圣女】" NOR;
	else 
		return HIR "【"+at+"圣母】" NOR;
		
if ( ob->query("family/family_name") == "天妖宫" )
	if(dx<1000) 
		return HIR "【 妖　女 】" NOR;
	else if(dx<10000) 
		return HIR "【 妖　精 】" NOR;
		...
		return HIR "【"+at+"女妖王】" NOR;
	else 
		return HIR "【"+at+"大女妖王】" NOR;
		
if ( ob->query("family/family_name") == "天魔宫" )
	if(dx<1000) 
		return HIR "【 小魔女 】" NOR;
	else if(dx<10000) 
		return HIR "【 妖　精 】" NOR;
...
if ( ob->query("family/family_name") == "藏尸地" )
	if(dx<1000) 
		return HIR "【 女死尸 】" NOR;
	else if(dx<10000) 
		return HIR "【 女丧尸 】" NOR;
		...
		return HIR "【"+at+"丧尸王后】" NOR;
	else 
		return HIR "【"+at+"僵尸王后】" NOR;

if ( ob->query("family/family_name") == "雷刀门" )
	if(dx<1000) 
		return HIR "【 女刀手 】" NOR;
	else if(dx<10000) 
		return HIR "【 女刀客 】" NOR;
		...
		return HIR "【"+at+"女刀仙】" NOR;
	else 
		return HIR "【"+at+"女刀王】" NOR;
	break;
*/
...
if ( ob->query("family/family_name") == "陷空山无底洞" )
		...
		return YEL "【"+at+"魔女】" NOR;	
	else 
		return YEL "【"+at+"女魔王】" NOR;
...
//begin 男性：
	default:
		switch(wizhood(ob)) 
		{
                        case "(admin)":         return HIW "【 三界帝王 】" NOR;
                        case "(arch)":                  return HIR "【 三界天王 】" NOR;
                        case "(wizard)":        return HIC "【 三界神君 】" NOR;
...
case "tianpeng":
        if(dx<1000) 
                ...
                return GRN "【"+at+"元帅左护法】" NOR;        
        else 
                return GRN "【"+at+"元帅左亲信】" NOR;
        break;
case "kunlun":                    
             if(dx<1000)  
                return CYN "【 小  仙 】" NOR;
             ...
             if(dx<100000)  
                return CYN "【 灵  仙 】" NOR;
             if(dx<500000)  
                return CYN "【"+at+"灵仙】" NOR;
             if(dx<700000)  
                return CYN "【"+at+"圣灵仙】" NOR;
            else  
                return HIW "【"+at+"圣灵尊】" NOR;
            break; 
case "youxia":
        if(dx<1000) 
                 return HIC "【 少 侠 】" NOR;
                ...
                return HIC "【 "+at+"侠士 】" NOR;
        else if(dx<500000) 
                return HIC "【 "+at+"大侠 】" NOR;
        else 
                return HIC "【 "+at+"圣侠 】" NOR;
        break;
case "wusheng":                    
	if(dx<1000) 
		return GRN "【 大罗刹 】" NOR;
...
if ( ob->query("family/family_name") == "三界山" )
	if(dx<1000) 
		...
		return HIR "【"+at+"妖仙魔】" NOR;
	else 
		return HIR "【"+at+"元神】" NOR;
...
if ( ob->query("family/family_name") == "天一宫" )
	if(dx<1000) 
		...
		return HIR "【"+at+"天师】" NOR;
	else 
		return HIR "【"+at+"祖师】" NOR;
...
if ( ob->query("family/family_name") == "天妖宫" )
	if(dx<1000) 
		...
		return HIR "【"+at+"妖王】" NOR;
	else 
		return HIR "【"+at+"大妖王】" NOR;
...
if ( ob->query("family/family_name") == "天魔宫" )
	if(dx<1000) 
		...
		return HIR "【"+at+"魔王】" NOR;
	else 
		return HIR "【"+at+"大魔王】" NOR;
...
if ( ob->query("family/family_name") == "藏尸地" )
	if(dx<1000) 
		...
		return HIR "【"+at+"丧尸王】" NOR;
	else 
		return HIR "【"+at+"僵尸王】" NOR;
...
if ( ob->query("family/family_name") == "雷刀门" )
	if(dx<1000) 
		...
		return HIR "【"+at+"刀仙】" NOR;
	else 
		return HIR "【"+at+"刀王】" NOR;
	break;
*/
...
if ( ob->query("family/family_name") == "火云洞" )
 ...
 if ( ob->query("family/family_name") == "陷空山无底洞" )
		...
		return YEL "【"+at+"老魔】" NOR;
	else 
		return YEL "【"+at+"魔王】" NOR;
