...
//        cat (banner); 
        cat(BANNER);
	write("        [ÖĞ¹úÁÉÄşÌúÁëÊĞ*ÖĞÎÄÍøÂçÓÎÏ·MUD"HIW"¡ºÎ÷ÓÎ¼ÇÖ®Èı½çÉñ»°¡»"NOR"]\n");
	write("        [[1;31mÌáÊ¾£º[0;37;0mÈç¹û°´ENTER¼üºóÏµÍ³Ã»ÓĞÏìÓ¦£¬ÇëÊÔ Ctrl-ENTER]\n\n");
	write("         Welcome to "BLINK HIY"SJSH!"NOR" Select GB or BIG5 (gb/big5):");
...
// try strict ban here...weiqi.
    ...
    printf("Èı½çÉñ»°("HIM"ÌúÁëÕ¾"NOR")ÏÖÓĞ×¢²áÍæ¼Ò"HIR"%s"NOR"Î»¡£\n",chinese_number(howmany_user()));
    printf("Èı½çÉñ»°("HIM"ÌúÁëÕ¾"NOR")¿ªÕ¾ÒÔÀ´£¬×î¸ßÔÚÏßÊıÄ¿£º"HIY"%s"NOR" ÈË£¬Æ½¾ùÔÚÏßÊıÄ¿£º"HIY"%s"NOR" ÈË¡£\n",chinese_number(max_online),chinese_number(avg_online));
...
ÇëÄú¸ø×Ô¼ºÏëÒ»¸ö·ûºÏ¡¼Èı½çÉñ»°¡½Éñ»°ÊÀ½çµÄÖĞÎÄÃû×Ö¡£Õâ
¸öÃû×Ö½«´ú±íÄãÔÚÈı½çÉñ»°ÖĞµÄÈËÎï£¬¶øÇÒÍùºó½«²»ÄÜÔÙ¸ü¸Ä¡£
...
{            
	...
	"/adm/daemons/toptend"->topten_checkplayer(user);
		...
		tell_room(startroom, user->query("name") + "Á¬Ïß½øÈëÕâ¸öÊÀ½ç¡£\n",
			({user}));
               // UPGRADE_D->upgrade(user);//koker 2001/09/16 ¶ÔÉı¼¶µÄÅĞ¶Ï¼ì²é
	     }
		 
   		if(file_size("/log/notice")>0){
                        write(HIY"     ¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô"HIR"Èı½çÉñ»°Á¬ÏßÍ¨Öª"NOR HIY"¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô\n");
                        write("     "+read_file("/log/notice"));
                        write(HIY"     ¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô¡Ô\n"NOR);        }
