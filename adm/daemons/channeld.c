...
mapping channels = ([
 "sys":  ([      "msg_speak": HIR "【"+HIW"系统"+HIR"】"+BLK"%s：%s\n" NOR, "wiz_only": 1 ]),
        ...
        "xyj":  ([      "msg_speak": HIR "【网际西游】%s：%s\n" NOR,
                                "msg_emote": HIR "【网际西游】%s\n" NOR,
                                "intermud": GCHANNEL, "channel": "xyj",
                                "filter": (:$1["MUDLIB"]=="A Journey to the West" :) ]),
        "es":   ([      "msg_speak": HIR "【"+HIW"潭际闲聊"+HIR"】"+HIW"%s：%s\n" NOR,
                                "msg_emote": HIR "【"+HIW"潭际闲聊"+HIR"】"+HIW"%s\n" NOR,
        ...
        "chat": ([      "msg_speak": HIC "【"+HIG"谈天说地"+HIC"】%s：%s\n" NOR,
                                "msg_emote": HIC "【"+HIG"谈天说地"+HIC"】%s\n" NOR,
                    "intermud":GCHANNEL,"channel":"chat",
                    "chat_new" : 1
                         ]),
         "job": ([      "msg_speak": HIY "【"+HIC"三界神话"+HIY"】"+HIG"%s：%s\n" NOR,
                                "msg_emote": HIY "【"+HIC"三界神话"+HIY"】"+HIG"%s\n" NOR,
                         "intermud":GCHANNEL,"channel":"job"
                         ]),
        "rumor":([      "msg_speak": HIG "【"+HIR"三界神话"+HIG"】"+HIM"%s：%s\n" NOR,
                                "msg_emote": HIC "【"+HIR"三界神话"+HIG"】"+HIM"%s\n" NOR,
                                "anonymous": "某人",
...
/*   　　　"club": ([      "msg_speak": HIB "【帮派】%s：%s\n" NOR,
                                "msg_emote": HIB "【帮派】%s" NOR,
                                "msg_color": HIB,
                                "party_only": 1 ]),
*/
        "new": ([        "msg_speak": HIR "『"HIB"初来乍到"HIR"』"HIG"%s：%s\n" NOR,
                                "msg_emote":  HIR "『"HIB"初来乍到"HIR"』"HIG"%s\n" NOR,

                          ]),

        "mp":  ([      "msg_speak": HIY "〖门派〗"+HIG"%s: %s\n" NOR,
                                  "msg_emote": HIY "〖门派〗"+HIG"%s\n" NOR,
                                 "msg_color": NOR+HIY,
                                 "menpai_only": 1 ]),

   "friendtalk":([ "msg_speak": HBMAG "〖亲朋好友〗%s: %s\n" NOR,
        ...
        return 1;
                ...
                if (channels[verb]["chat_new"])
           {
               switch(me->query("class"))
                { 
                        case "dragon":
                        channels[verb]["msg_speak"] = WHT "〖"HIG"东海神龍"WHT"〗"HIC"%s：%s\n" NOR;
                        break;
                        case "xian":
                        channels[verb]["msg_speak"] = WHT "〖"HIG"九天北斗"WHT"〗"HIC"%s：%s\n" NOR;
                        break;
                        case "bonze":
                        channels[verb]["msg_speak"] = WHT "〖"HIG"释迦牟尼"WHT"〗"HIC"%s：%s\n" NOR;

                        break;
                        case "yaomo":
                        channels[verb]["msg_speak"] = WHT "〖"HIG"妖魔鬼怪"WHT"〗"HIC"%s：%s\n" NOR;
                        break;
                        case "swordsman":
                        channels[verb]["msg_speak"] = WHT "〖"HIG"天外飞仙"WHT"〗"HIC"%s：%s\n" NOR;
                        break;
                        case "taoist":
                        break;
                        case "youling":           
                        channels[verb]["msg_speak"] = WHT "〖"HIG"十八地狱"WHT"〗"HIC"%s：%s\n" NOR;
                        break;
                        case "scholar":
                        case "fighter": 
                        channels[verb]["msg_speak"] = WHT "〖"HIG"兵马元帅"WHT"〗"HIC"%s：%s\n" NOR;
                        break;
                        case "wiz": 
                        channels[verb]["msg_speak"] = WHT "〖"HBRED HIW"天    神"NOR""WHT"〗"HIC"%s：%s\n" NOR;
                        break;
                        default:
                               channels[verb]["msg_speak"] = WHT "〖"HIG"谈天说地"WHT"〗"HIC"%s：%s\n" NOR;
                               break;
                }                 
            }
