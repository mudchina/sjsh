...
//message("system",HIG"¡¾Ì«Æ½Ê¢ÊÀ¡¿Ô¬Ììî¸(yuan tiangang)£º"+me->name()+"ÕÒµ½ÁË"+quest_item->name()+",½»¸ø"+who->name()+"µÃµ½ÁË"+daoxing(exp)+"µÀÐÐºÍ"+chinese_number(pot)+"µãÇ±ÄÜ¡£\n"NOR,users());
MONITOR_D->report_system_object_msg(me, HIG"ÕÒµ½ÁË"+quest_item->name()+",½»¸ø"+who->name()+"µÃµ½ÁË"+daoxing(exp)+"µÀÐÐºÍ"+chinese_number(pot)+"µãÇ±ÄÜ¡£\n"NOR);
...
string dyn_quest_list()
{
   ...
   output="";
        ...
        output ="[1;32m¡ù[31mÈý½çÉñ»°Ê¹Ãü°ñ[32m¡ù[m\n"+
                "©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥\n"+output+
                "©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥©¥\n\n";
...
return notify_fail("locate <ÎïÆ·id>\n");
    ...
    if(!already_spreaded(quest)){
        tell_object(me,HIW"²Ø±¦Í¼"NOR"Ò»µã·´Ó¦Ò²Ã»ÓÐ£¬·Â·ðËü¸ù±¾²»´æÔÚÕâ¸öÊÀ½çÉÏ¡£\n");
        return 0;
    }
    ...
    for(index=0;index<sizeof(itemlist);index++){
      if(objectp(loc=find_env(itemlist[index]))){
          ...
          if(sizeof(exlst)){
                ...
                tell_object(me,HIW"²Ø±¦Í¼"NOR"ÏÔÊ¾£º\n"+msg);
                return 1;
          }    
      }
    }   
    tell_object(me,HIW"²Ø±¦Í¼"NOR"Ò»µã·´Ó¦Ò²Ã»ÓÐ¡£\n");
    return 1;
}
